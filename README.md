...
JEFF-MC/install
```
JEFF-MC requires at least the following packages: `git, screen, dialog, buildessential, gcc` and a Java Runtime Engine. It has been tested on a minimal installation of Debian 9.
